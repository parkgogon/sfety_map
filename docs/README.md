...
0. [MAP_VISUAL_REFINEMENT_PLAN.md](MAP_VISUAL_REFINEMENT_PLAN.md) — 진행 중인 지도 마커·기상 그래픽 시각 개선 계획
0. [SIMULATION_MAP_UX_IMPROVEMENT_PLAN.md](SIMULATION_MAP_UX_IMPROVEMENT_PLAN.md) — 실화면 검수에 따른 모의훈련 지도·기상 그래픽 단계별 개선 계획
